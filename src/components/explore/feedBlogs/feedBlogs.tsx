                ...
                <ul className='flex flex-wrap items-center mobile:justify-center gap-x-[2vw] gap-y-[3vh] w-full '>
                    {feedDetails.content.map((e : FeedBlogDetail)=>{
                        return (
                            <li
                                key={e.eventTitle}
                                className='mobile:w-[30rem] mobile:h-full sm:w-[30rem] md:h-[45vh] md:w-[20rem] lg:w-[25rem] lg:min-h-[52vh] md:hfit bg-gray-100 border border-gray-100 hover:opacity-80 rounded-xl hover:shadow-lg transition-all'
                            >
