...
export default function HeroSection() {
  return (
    <section className="flex bg-white  text-center mobile:h-[60vh] md:h-screen w-screen items-center">
      <div className="flex flex-col items-center justify-center px-[4vw] w-full">
        ...
        <p className="mt-4 mobile:text-base md:text-lg lg:text-xl text-gray-600">Join the future of events with our secure and transparent platform test cicd automation.</p>
